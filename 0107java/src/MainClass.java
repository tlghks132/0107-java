...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		//위의 구문은 수행을 하고 인스턴스의 참조를 리턴한다.
		//이 인스턴스를 재사용할려면 인스턴스의 참조를 동일한 자료형의 변수에 대입을 해야 한다.
		...
		ob1.name = "첫번째 인스턴스";
		ob2.name = "두번째 인스턴스";
		//static이 붙지 않은 멤버는 클래스는 호출 할 수 없다.
		...
		//출력을 해보면 동일한 값을 출력
		System.out.print(ob1.share);
		System.out.print(ob1.name);
		System.out.print(SampleClass.share);
